...
namespace strange.test.main
{
	...
	{
		public SignalContext (MonoBehaviour contextView) : base(contextView, strange.extensions.context.api.ContextStartupFlags.MANUAL_MAPPING)
		{
		}
...
//			dispatcher.Dispatch(ContextEvent.START);
		...
		protected override void mapBindings(){
			base.mapBindings();
			implicitBinder.ScanForAnnotatedClasses(new string[]{"strange.test.main"});
		}
	}
}
