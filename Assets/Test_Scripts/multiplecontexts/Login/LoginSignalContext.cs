...
{
	public class LoginSignalContext :MVCSContext
	{
		public LoginSignalContext (MonoBehaviour contextView) : base(contextView, strange.extensions.context.api.ContextStartupFlags.MANUAL_MAPPING)
		{
		}
		...
		protected override void mapBindings(){
			base.mapBindings();
			implicitBinder.ScanForAnnotatedClasses(new string[]{"strange.test.login"});
		}
	}
}
